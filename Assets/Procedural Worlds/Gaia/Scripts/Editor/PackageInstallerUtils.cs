                ...
                try
                {
                    ...
                    foreach (MaterialLibraryEntry entry in m_materialLibrary)
                    {
                        ...
                        try
                        {
                            ...
                            {
                                string packageName = entry.m_builtInMaterialUnitypackage;
                                switch (m_renderPipeline)
                                {
                                    case GaiaConstants.EnvironmentRenderer.BuiltIn:
                                        packageName = entry.m_builtInMaterialUnitypackage;
                                        break;
                                    case GaiaConstants.EnvironmentRenderer.Universal:
                                        packageName = entry.m_URPMaterialUnitypackage;
                                        break;
                                    case GaiaConstants.EnvironmentRenderer.HighDefinition:
                                        packageName = entry.m_HDRPMaterialUnitypackage;
                                        break;
                                }
                                ...
                                if (!string.IsNullOrEmpty(packageName))
                                {
                                    ...
                                    string packagePath = AssetDatabase.GetAssetPath(AssetDatabase.LoadAssetAtPath<UnityEngine.Object>(GaiaUtils.GetAssetPath(packageName)));
