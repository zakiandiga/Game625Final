...
namespace Gaia
{
    public static class GaiaConstants
    {
        ...
        /// </summary>
        public enum EnvironmentControllerType { FirstPerson, FlyingCamera, ThirdPerson, XRController, Custom, None }
        ...
        public static readonly string HDRPPWSkyExperimental = "Procedural Worlds Sky is not yet available in HDRP, this will be available soon. If you would like to try it out then you can enable this feature by adding GAIA_EXPERIMENTAL to the scripting define in Project Settings/Player settings.";
        /// <summary>
        /// 
        /// </summary>
        ...
        /// </summary>
        public static string gaiaTerrainLoaderManagerObjects = "Terrain Loader";
