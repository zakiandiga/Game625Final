...
namespace Gaia
{
    public static class GaiaLighting
    {
            ...
            try
            {
                ...
                if (renderPipeline == GaiaConstants.EnvironmentRenderer.BuiltIn)
                {
                    ...
                    if (m_lightingProfile.m_enablePostProcessing)
                    {
                        ...
                        ConfigureAntiAliasing(lightProfile.m_antiAliasingMode, renderPipeline);
        ...
        /// <param name="profile"></param>
        public static void ConfigureAntiAliasing(GaiaConstants.GaiaProAntiAliasingMode antiAliasingMode, GaiaConstants.EnvironmentRenderer renderPipeline)
        {
            try
            {
